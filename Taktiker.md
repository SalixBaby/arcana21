...
- **Klassenfähigkeit:** Kriegsführung
	- Deine Präsenz auf dem Schlachtfeld verändert alles – noch bevor der erste Schlag fällt. Du erkennst die Lage, wertest das Terrain aus und gibst präzise Befehle, die deinen Verbündeten einen entscheidenden Vorteil verschaffen.

- ***Zusätzliche Erklärung für Kriegsführung:***
	- Zu Beginn jedes Kampfes darfst du eine von sechs taktischen Anweisungen wählen, die allen Verbündeten in Hörreichweite bis zum Ende des Kampfes zugutekommt:
		- **Schneller Vorstoß** – Alle Verbündeten erhalten **+1 AP** in der ersten Runde.
		- **Bewegliche Formation** – Alle Verbündeten erhalten **+1 auf Bewegungsrate**.
		- **Eiserne Moral** – Alle Verbündeten erhalten **+1 auf Willensstärke**.
		- **Wachsame Haltung** – Alle Verbündeten erhalten **+1 auf Ausweichen**.
		- **Kampfkraft steigern** – Alle Verbündeten erhalten **+1 auf Angriffsproben**.
		- **Durchhaltevermögen** – Alle Verbündeten erhalten **+1 temporäre Gesundheit** für diesen Kampf.
...
- **Praktiker**: Du hast selbst gekämpft, Kommandos gebrüllt und Entscheidungen unter Lebensgefahr getroffen. Du vertraust deiner Erfahrung und reagierst schnell, wenn andere noch überlegen.
    - +1 [[./Konstitution|Konstitution]]
    - +1 [[./Überzeugen|Überzeugen]]
...
- **Meisterkriegsführung**: Alle deine taktischen Anweisung sind permanent für dich und alle deine Verbündeten aktiv.
- **Meisterstratege**: Deine taktischen Fähigkeiten sind legendär. Mit genug Zeit und Ressourcen kannst du deine Pläne so ausarbeiten, dass sie praktisch unfehlbar sind.