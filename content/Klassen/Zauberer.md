...
- **Magische Runenkunde**: Du kannst magische Runen aller Art lesen, erkennen und deuten. Sofern sie auf dir bekannten Zauberausrichtungen basieren kannst du diese deinen Fähigkeiten entsprechende präzise nachzeichnen oder rekonstruieren.  
- **Magische Sorgfalt**: Wenn du einen Zauber mit Vorbereitung von einer Minute (z. B. durch Ritual, Meditationsphase oder Zeichnung eines Kreises) wirkst, erhältst du auf die Arkana-Probe einen Bonus.  
...
- **Magische Analyse**: Du kannst als Reaktion 1 AP ausgeben um gegnerische Zauber beim Wirken zu analysieren. Mit einer erfolgreichen Arkana-Probe kennst du ihre genaue Wirkung – oder Schwäche. Du erhältst einen Bonus auf Zauberduelle gegen diesen Zauber.  
- **Magischer Anker**: Du kannst einen Zauber mit einem zeitverzögerten Auslöser versehen. Dabei kannst du entscheiden, ob der Zauber sich nach Sekunden, Minuten oder bei einem bestimmten Reiz (z. B. ein Geräusch, eine Bewegung, eine magische Aura) entfaltet. Diese halten jedoch maximal 24 Stunden.  
...
- **Magisches Verständnis**: Du hast die arkanen Künste bis in ihr tiefstes Inneres durchdrungen. Dir stehen nun alle regulären Zauberausrichtungen außer einer zur Verfügung, unabhängig von deiner bisherigen Auswahl.  
- **Magisches Ultimatum**: Dein Wissen über Magie ist absolut. Du kannst Zauber beliebig stark überladen – auch über die reguläre Managrenze hinaus. Bei Zaubern mit mehr als 5 aufgewendeten Mana entscheidet eine Fokusprobe, wie präzise und kontrolliert du sie entfesselst. Misserfolg bedeutet nicht Scheitern, sondern unvorhersehbare Konsequenzen.  
