...
**Kooperation und Kreativität:** In **Arcana21** steht das gemeinsame Erzählen einer Geschichte im Vordergrund. Jeder Spieler bringt seine eigene Perspektive und Kreativität ein, um die Welt lebendig zu gestalten.  
...
[Völkerübersicht](V%C3%B6lker/-V%C3%B6lker-.md)  
...
[Hintergrundsübersicht](Hintergr%C3%BCnde/-Hintergr%C3%BCnde-.md)  
...
- **[Seele](Attribute/Seele/-Seele-.md)** für Charisma und Inspiration.  
  
Diese [Attribute](Attribute/-Attribute-.md) bestimmen, wie gut dein Charakter in verschiedenen Situationen abschneidet und beeinflussen die Verteilung von Unterattributen wie Geschicklichkeit, Wahrnehmung oder Überzeugen.  
...
[Attributsübersicht](Attribute/-Attribute-.md)  
...
- [Waffen](Ausr%C3%BCstungen/Waffen/-Waffen-.md) (Maximal 2 Waffen, wobei nicht beide [Schwer](Ausr%C3%BCstungen/Waffen/Waffeneigenschaften/Schwer.md) sein dürfen)  
- [Ausrüstungssets](Ausr%C3%BCstungen/Ausr%C3%BCstungssets/-Ausr%C3%BCstungssets-.md) (Durch Ausbildung bestimmt)  
- [Rüstungen](Ausr%C3%BCstungen/R%C3%BCstungen/-R%C3%BCstungen-.md) (Jeder Held kann mit jeder Art von Rüstung starten, die er tragen kann)  
...
- **Weltaufbau:** Erschaffen von Städten, Dörfern, Landschaften und Dungeons. Der Spielleiter sollte die Welt dynamisch gestalten, sodass sie sich lebendig und glaubwürdig anfühlt.  
- **Moderation:** Sicherstellen, dass das Spiel flüssig abläuft, Regeln eingehalten werden und jeder Spieler seinen Moment im Rampenlicht hat.  
- **Entscheidungsgewalt:** Bei Unsicherheiten über Regeln oder Spielmechaniken hat der Spielleiter das letzte Wort.  
...
- **Dungeons:** Gestaltung von gefährlichen Orten voller Fallen, Rätsel, Gegner und wertvoller Beute. Dungeons sollten Spannung und Neugier wecken.  
- **Themenvielfalt:** Die Welt sollte verschiedene Themen bieten – von idyllischen Regionen bis hin zu düsteren, gefährlichen Orten.  
...
- **Rollenspiel:** Der Spielleiter kann den NPCs durch unterschiedliche Stimmen, Verhaltensweisen und Motivationen Tiefe verleihen.  
...
- Das wiederholte Ausführen derselben Aktion in derselben Runde kostet pro Wiederholung **+1 zusätzlichen Aktionspunkt**.  
    - Beispiel: Der erste Angriff kostet 1 AP, ein zweiter Angriff in derselben Runde kostet 2 AP.  
    - Gelegenheitsangriffe, die außerhalb der eigenen Runde ausgeführt werden, zählen nicht als Wiederholung der Angriff-Aktion sondern werden separat behandelt.  
...
- **Fernkampfwaffen:** Bogen, Armbrust, Wurfmesser usw.  
...
**5.1.2 Zauberarten:**    
Die Magie in Arcana21 ist vielseitig und wird in verschiedene Zauberarten unterteilt:  
  
- **Angriffszauber:** Fügen Gegnern Schaden zu oder setzen sie unter negative Effekte.  
- **Verteidigungszauber:** Erzeuge Heilung, magische Barrieren oder Abwehrmechanismen.  
- **Unterstützungszauber:** Unterstütze deine Verbündeten oder manipuliere die Umgebung.  
...
Anstelle der zwei Fähigkeiten, die der Charakter auf seinem nächsten Level durch seine Hauptklasse erhält, kann er eine **Fähigkeit derselben Stufe** aus einer anderen Klasse wählen.  
Die Wahl dieser Fähigkeit muss **logisch in die Geschichte und Entwicklung des Charakters passen**.  
  
**6.2.2 Einschränkungen:**  
Der Wechsel ist **nur in Absprache mit dem Spielleiter** möglich.  
Spieler sollten gut begründen können, warum ihr Charakter eine Fähigkeit aus einer anderen Klasse erhalten sollte.  
Multiklassen dürfen keine systematischen **Vorteile durch unpassende Kombinationen** ausnutzen (z. B. Fähigkeiten, die unlogisch synergieren).  
  
**6.2.3 Balance:**  
Die Klassenkombination erlaubt maximal **eine Fähigkeit pro Level-Up** aus einer anderen Klasse.  
Der Charakter bleibt weiterhin primär in seiner Hauptklasse.  
...
>***Ausbildungspunkte** in Arcana21 repräsentieren die spezialisierte Bildung und das Wissen, das dein Charakter während seines Lebens gesammelt hat. Sie ermöglichen es dir, zusätzliche Fähigkeiten und Kenntnisse zu erlangen, die deinen Charakter einzigartig und anpassungsfähig machen.*  
...
- **Nutzung:** Der Held kann Inspirationspunkte einsetzen, um einem Verbündeten in Hörreichweite im Kampf oder außerhalb davon einen Vorteil auf seinen nächsten Wurf zu geben. Dieser Vorteil besagt, dass eine Probe zwei mal gewürfelt werden und davon das bessere Ergebnis genutzt werden kann. Der Vorteil muss vor dem Wurf angekündigt werden.  
