...
- **Segen der Stille**: Du kannst einmal am Tag für 1 AP eine Aura von (Level x) 5 Metern erschaffen, die für eine Minute äußere magische Einflüsse dämpft. Innerhalb dieser Aura erhalten Gegner einen Malus auf Zauber, jedoch muss für jeden geschwächten Zauber eine Fokus-Probe bestanden werden.

#### **4. Level**

- **Segen des Kampfes**: Im Kampf auf Leben und Tod regenerieren alle Verbündeten im Umkreis von 5 Metern beim Anfang ihres Zuges eine beliebige Ressource (Mana, Ausdauer, Inspiration, Gesundheit).
